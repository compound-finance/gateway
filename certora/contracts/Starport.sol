...
contract Starport {
    ...
    function hashNotice(bytes calldata data) virtual internal pure returns (bytes32) {
    ...
    function recover(bytes32 digest, bytes memory signature) virtual internal view returns (address) {
