...
pub fn new_full_base(
    ...
    // XXX we probably want this? need to add to chain_spec and runtime lib
...
mod tests {
    ...
    use compound_chain_runtime::{
        opaque::Block, Address, BalancesCall, Call, DigestItem, Signature, UncheckedExtrinsic,
        SLOT_DURATION,
    };
    ...
    use sp_runtime::{key_types::BABE, RuntimeAppPublic};
    use sp_timestamp;
