...
use crate::{
    chains::{
        ...
        ChainEvent, ChainEvents, ChainHash, ChainId, ChainReorg, ChainReorgTally, ChainSignature,
        ChainSignatureList,
    },
...
decl_event!(
    pub enum Event {
        ...
        ProcessedChainEvent(ChainEvent),

        /// An Ethereum event failed during processing. [event_id, reason]
        FailedProcessingChainEvent(ChainEvent, Reason),
