...
pub mod testnet {
    ...
    pub const ETH_STARPORT_BLOCK: ChainBlock = ChainBlock::Eth(ethereum_client::EthereumBlock {
        hash: [
            81, 40, 23, 157, 87, 51, 105, 157, 105, 27, 30, 132, 21, 141, 134, 60, 227, 84, 169,
            204, 107, 233, 62, 18, 170, 146, 25, 176, 165, 38, 59, 180,
        ],
        parent_hash: [
            63, 153, 190, 160, 212, 253, 197, 144, 138, 202, 162, 76, 17, 72, 33, 7, 22, 20, 12,
            115, 142, 126, 225, 85, 58, 67, 24, 105, 137, 59, 39, 104,
        ],
        number: 10267646,
        events: vec![],
    });
